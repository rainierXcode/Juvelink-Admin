...
import Login1 from '@/assets/bg/loginBg1.svg'
import Login2 from '@/assets/bg/loginBg2.svg'
    ...
    return (
        <div className="flex h-screen font-poppins">
            <div className="col-span-4 relative bg-red-400 w-[500px] flex items-center justify-center" style={{background: 'linear-gradient(180deg, rgba(94, 99, 255, 0.8) 0%, rgba(0, 0, 130, 0.8) 100%)'}}>
                <Image src={Login1} alt="loginsvg1" width={100} height={100} className="absolute top-0 w-full h-auto"/>
                <Image src={Login2} alt="loginsvg2" width={100} height={100} className="absolute bottom-0 w-full h-auto"/>
